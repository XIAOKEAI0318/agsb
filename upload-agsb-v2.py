...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "xiaokeai"         # 用户名
UUID = "14c6170c-6b9c-4026-9098-99f7bf78d9ed"                     # UUID，留空则自动生成
PORT = 32564                   # Vmess端口，留空或0则自动生成
DOMAIN = "share.xiaokeai.cc.ua"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNTE2YjRhYzc3MjNiZjA0MjBhNDFiODBjN2YxN2ExZmUiLCJ0IjoiODJlYTIyMTItNjViOS00YWRlLWFhOWMtMTE3MjA2MzQ0NDIwIiwicyI6IlpESTVZMlJpWVdRdFlXSTVZUzAwTXpReExXSmtZVGN0WkRRM1l6YzVNRFUyTjJFMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
